  ...
  <transition name="fade">
    ...
    >
      ...
      <transition name="slide">
        <div
          class="relative px-4 md:px-7 py-6 md:py-8 z-[9999] mt-4 mx-4 bg-white max-w-full md:max-w-[650px] overflow-y-auto overflow-x-hidden transition-all duration-500"
          :class="{
